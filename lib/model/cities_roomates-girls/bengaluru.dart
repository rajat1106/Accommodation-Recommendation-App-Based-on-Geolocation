...
class _Bang2PageState extends State<Bang2Page> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Person> persons = [
     Person(name: 'Sammrudhi patekar', profileImg: 'images/avatar_girl.png', bio: "Student at CHRIST"),
     Person(name: 'Bhavna CR', profileImg: 'images/avatar_girl.png', bio: "Student at VIT Vellore"),
